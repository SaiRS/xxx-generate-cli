...
module.exports = function createWebpackConfig(webpackEnv) {
  // 环境部分
  // 开发环境，代码不做压缩混淆处理
  const isEnvironmentDevelopment = webpackEnv === 'development';
  // 生产环境，执行一些优化处理，代码要经过压缩处理
  const isEnvironmentProduction = webpackEnv === 'production';
  ...
  const publicPath = !isEnvironmentDevelopment ? paths.servedPath : '/';

  // `publicUrl` is just like `publicPath`, but we will provide it to our app
  // as %PUBLIC_URL% in `index.html` and `process.env.PUBLIC_URL` in JavaScript.
  // Omit trailing slash as %PUBLIC_URL%/xyz looks better than %PUBLIC_URL%xyz.
  const publicUrl = !isEnvironmentDevelopment ? publicPath.slice(0, -1) : '';
    ...
    const loaders = [
      ...
      },
      {
        ...
        options: {
          ...
          sourceMap: !isEnvironmentDevelopment && shouldUseSourceMap,
        },
      },
    ].filter(Boolean);
    if (preProcessor) {
  ...
  return {
    ...
    output: {
      // The build folder.
      path: !isEnvironmentDevelopment ? paths.appBuild : undefined,
      // Add /* filename */ comments to generated require()s in the output.
      pathinfo: !isEnvironmentProduction,
      // There will be one main bundle, and one file per asynchronous chunk.
      // In development, it does not produce real files.
      filename: !isEnvironmentDevelopment
        ? 'static/js/[name].[contenthash:8].js'
        : 'static/js/bundle.js',
      // TODO: remove this when upgrading to webpack 5
      futureEmitAssets: true,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: !isEnvironmentDevelopment
      ...
      devtoolModuleFilenameTemplate: !isEnvironmentDevelopment
        ? (info) =>
            path
          ...
          oneOf: [
            {
              ...
              use: {
                ...
                options: {
                  ...
                  compact: !isEnvironmentDevelopment,
                },
              },
            },
            // {
    ...
    plugins: [
      ...
      // to restart thEnvironmentPlugine development server for Webpack to discover it. This plugin
      ...
      new ManifestPlugin({
        ...
        generate: (seed, files) => {
          const manifestFiles = files.reduce(function manif(manifest, file) {
      ...
      // The fix is luckily very simple.
